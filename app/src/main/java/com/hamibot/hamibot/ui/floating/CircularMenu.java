...
import com.hamibot.hamibot.autojs.record.GlobalActionRecorder;
...
import com.hamibot.hamibot.tool.RootTool;
...
public class CircularMenu implements Recorder.OnStateChangedListener, LayoutInspector.CaptureAvailableListener {
    ...
    void inspectLayout() {
        ...
        mLayoutInspectDialog = new OperationDialogBuilder(mContext)
                .item(R.id.layout_bounds, R.drawable.ic_hamibot_convert, R.string.text_inspect_layout_bounds)
                .item(R.id.layout_hierarchy, R.drawable.ic_hamibot_layer,
