...
public class Pref {
    ...
    public static String getToken() {
        return def().getString(KEY_TOKEN, "");
    }

    public static void setToken(String token) {
        def().edit().putString(KEY_TOKEN, token).apply();
    }

    public static String getRobotName() {
        return def().getString(KEY_ROBOT_NAME, "");
    }

    public static void setRobotName(String name) {
        def().edit().putString(KEY_ROBOT_NAME, name).apply();
    }
